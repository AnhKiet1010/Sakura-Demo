                ...
                listMessages.map((mess, i) => {
                    ...
                    if (mess.fromId === currentUser.lineId) {
                        if (mess.type === 'image') {
                            ...
                            result = <TextMess key={i} word={word} avatar={currentUser.avatar} time={mess.time} text={mess.content} seen={mess.seen} messId={mess._id} react={mess.react} handleReply={handleReply} reply={mess.reply} />
                        }
                    } else {
                        if (mess.type === 'image') {
                        result = <SelfImgMess key={i} time={mess.time} images={mess.images} seen={mess.seen} slideImages={slideImages} />
                            ...
                            result = <SelfMess key={i} word={word} text={mess.content} seen={mess.seen} time={mess.time} messId={mess._id} react={mess.react} reply={mess.reply} handleReply={handleReply} />
                        }
                    }
                    return result;
                })
